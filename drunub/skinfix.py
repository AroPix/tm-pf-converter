...
def fix_skin(file_path, file_path_out=None, lod_dists=LOD_DISTS):
    if not file_path_out: file_path_out = file_path
...
if __name__ == "__main__":
    ...
    fix_skin(file_path, file_path_out, lod_dists=lod_dists)